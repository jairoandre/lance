...
CREATE TABLE "USRDBVAH"."TB_LANCA_SER_SEC_CON"
(
  ID decimal(38, 0) PRIMARY KEY NOT NULL,
  ID_CONTA decimal(38, 0) NOT NULL,
  ID_SETOR decimal(38, 0) NOT NULL,
  ID_SERVICO decimal(38, 0) NOT NULL
);
ALTER TABLE "USRDBVAH"."TB_LANCA_SER_SEC_CON" ADD CONSTRAINT FK_SER_SEC_CON_PL_CON FOREIGN KEY (ID_CONTA) REFERENCES "DBAMV"."PLANO_CONTAS" (CD_REDUZIDO);
// ALTER TABLE "USRDBVAH"."TB_LANCA_SER_SEC_CON" ADD CONSTRAINT FK_SER_SEC_CON_SET FOREIGN KEY (ID_SETOR) REFERENCES DBAMV.SETOR (CD_SETOR) NOT DEFERRABLE ;
ALTER TABLE "USRDBVAH"."TB_LANCA_SER_SEC_CON" ADD CONSTRAINT FK_SER_SEC_CON_LAN_SER FOREIGN KEY (ID_SERVICO) REFERENCES "USRDBVAH"."TB_LANCA_SERVICO" (ID);

CREATE INDEX IDX_LAN_SER_SEC_CON_SETOR ON USRDBVAH.TB_LANCA_SER_SEC_CON (ID_SETOR);
CREATE INDEX IDX_LAN_SER_SEC_CON_SERV ON USRDBVAH.TB_LANCA_SER_SEC_CON (ID_SERVICO);
CREATE INDEX IDX_LAN_SER_SEC_CON_CONTA ON USRDBVAH.TB_LANCA_SER_SEC_CON (ID_CONTA);
