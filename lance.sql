...
CREATE INDEX IDX_SETOR_CONTA_CONTA ON USRDBVAH.TB_LANCA_SETOR_CONTA (CD_REDUZIDO);
CREATE INDEX IDX_SETOR_CONTA_SETOR ON USRDBVAH.TB_LANCA_SETOR_CONTA (CD_SETOR);
