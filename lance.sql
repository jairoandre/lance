...
(
  ...
  CONSTRAINT FK_LANCA_CON_SER_CON FOREIGN KEY (ID_CONTRATO) REFERENCES USRDBVAH.TB_LANCA_CONTRATO (ID),
  CONSTRAINT FK_LANCA_CON_SER_SER FOREIGN KEY (ID_SERVICO) REFERENCES USRDBVAH.TB_LANCA_SERVICO (ID)
);