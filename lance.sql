...
ALTER TABLE USRDBVAH.TB_LANCA_USUARIO_SERVICO ADD CONSTRAINT FK_3A2F0J0TAFDLVYGNGEPM4AVRO FOREIGN KEY ( ID_PUSER ) REFERENCES USRDBVAH.TB_LANCA_USUARIO ( ID ) NOT DEFERRABLE ;
ALTER TABLE USRDBVAH.TB_LANCA_LANCAMENTO ADD CONSTRAINT FK_AQDGFNHUVX3X06YXC17PNR91U FOREIGN KEY ( ID_USU_LANCADOR ) REFERENCES USRDBVAH.TB_LANCA_USUARIO ( ID ) NOT DEFERRABLE ;
...
ALTER TABLE USRDBVAH.TB_LANCA_COMENTARIOS ADD CONSTRAINT FK_LANC_COMEN FOREIGN KEY ( ID_LANCAMENTO ) REFERENCES USRDBVAH.TB_LANCA_LANCAMENTO ( ID ) NOT DEFERRABLE ;
ALTER TABLE USRDBVAH.TB_LANCA_COMENTARIOS ADD CONSTRAINT FK_LAN_CON FOREIGN KEY ( ID_PUSER ) REFERENCES USRDBVAH.TB_LANCA_USUARIO ( ID ) NOT DEFERRABLE ;
...
ALTER TABLE USRDBVAH.TB_LANCA_SERVICO ADD CONSTRAINT FK_LAN_SER_RESU FOREIGN KEY ( CD_CONTA_RESULTADO ) REFERENCES DBAMV.PLANO_CONTAS ( CD_REDUZIDO ) NOT DEFERRABLE ;
...
ALTER TABLE USRDBVAH.TB_LANCA_SERVICO ADD CONSTRAINT FK_LKUFQ53Y170LNMCW7M5T3TOJ0 FOREIGN KEY ( CD_HISTORICO_PADRAO ) REFERENCES DBAMV.HISTORICO_PADRAO ( CD_HISTORICO_PADRAO ) NOT DEFERRABLE ;
