...
CREATE TABLE "USRDBVAH"."TB_LANCA_SETOR_CONTA"
(
  ID INTEGER NOT NULL,
...
CREATE UNIQUE INDEX USRDBVAH.PK_SETOR_CONTA_IDX ON USRDBVAH.TB_LANCA_SETOR_CONTA
(
    ID ASC
);
ALTER TABLE "USRDBVAH"."TB_LANCA_SETOR_CONTA" ADD CONSTRAINT PK_SETOR_CONTA PRIMARY KEY ( ID ) USING INDEX USRDBVAH.PK_SETOR_CONTA_IDX ;
ALTER TABLE "USRDBVAH"."TB_LANCA_SETOR_CONTA" ADD CONSTRAINT FK_SETOR_CONTA_CONTA FOREIGN KEY (CD_REDUZIDO) REFERENCES "DBAMV"."PLANO_CONTAS" (CD_REDUZIDO);
ALTER TABLE "USRDBVAH"."TB_LANCA_SETOR_CONTA" ADD CONSTRAINT FK_SETOR_CONTA_SETOR FOREIGN KEY (CD_SETOR) REFERENCES "DBAMV"."TB_SETOR" (CD_SETOR);
...
CREATE SEQUENCE USRDBVAH.SEQ_LANCA_SETOR_CONTA;
