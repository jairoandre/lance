...
public class ArquivoRemessa {
  ...
  public static final String CONTA_CONVENIO = "CONTA_CONVENIO";
  public static final String DAC_AGENCIA = "DAC_AGENCIA";
  public static final String NOME_EMPRESA = "NOME_EMPRESA";
  public static final String DATA_GERACAO = "DATA_GERACAO";
  public static final String HORA_GERACAO = "HORA_GERACAO";
  ...
  public static final String CONTA_CREDITADA = "CONTA_CREDITADA";
  ...
  public static final String CONTA_DEBITADA = "CONTA_DEBITADA";
  public static final String NOME_DEBITADO = "NOME_DEBITADO";
  public static final String NUMERO_EMPRESA = "NUMERO_EMPRESA";
  public static final String DATA_AGENDADA = "DATA_AGENDADA";
  public static final String TIPO_MOEDA = "TIPO_MOEDA";
  public static final String QUANTIDADE_MOEDA = "QUANTIDADE_MOEDA";
  public static final String VALOR_AGENDADO = "VALOR_AGENDADO";
  public static final String TIPO_MORA = "TIPO_MORA";
  public static final String VALOR_MORA = "VALOR_MORA";
  public static final String INSCRICAO_DEBITADO = "INSCRICAO_DEBITADO";
